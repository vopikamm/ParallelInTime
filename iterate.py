...
def set_start_values_for_coarse_solver_for_one_time_slice(prev_time_slice, prev_time_slice_end, counter):
    ...
    fromDirectory = opt.name_folders + str(prev_time_slice) + '_' + str(counter) + '/' + str(int(prev_time_slice_end))
...
def run_coarse_solver_for_single_time_slice(time_slice, time_slice_start, time_slice_end,counter):
